                ...
                <View style={IndexStyle.p4}>
                    ...
                    <View style={IndexStyle.mt}>
                        ...
                        <View style={[IndexStyle.container, IndexStyle.row]}>
                            <Text variant='bodySmall' style={IndexStyle.textMuted}>App Version 1.0.0 (30)</Text>
                            </View>
                    </View>
                    </View>
            </ScrollView>
