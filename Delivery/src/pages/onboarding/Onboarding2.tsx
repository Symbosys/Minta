...
export default function Onboarding2({ navigation }: { navigation: NavigationProp<any, any> }) {

        return (
            <ScrollView >
                <View style={[IndexStyle.container, IndexStyle.p5]}>
                    <Image style={[IndexStyle.mb, IndexStyle.mt]} height={350} width={350} source={{ uri: "https://img.freepik.com/free-vector/bike-sharing-abstract-concept-illustration_335657-1848.jpg?ga=GA1.1.265960106.1740721772&semt=ais_hybrid" }} />
   ...
   <View style={[dot.container]}>
                ...
                <View style={[IndexStyle.p5]}>
                    <Button icon="arrow-right" mode="contained" onPress={() => navigation.navigate('Onboarding3')}>
                        Next
                    </Button>
