...
export default function Onboarding2({ navigation }) {
   ...
   <View style={[dot.container]}>
                ...
                <View style={[IndexStyle.p5]}>
                    <Button icon="arrow-right" mode="contained" onPress={() => navigation.replace('Onboarding3')}>
                        Next
                    </Button>
                    <Button style={IndexStyle.pt} mode="text" onPress={() => navigation.replace('Permission')}>
                        Skip
                    </Button>
                </View>
